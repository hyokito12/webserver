...
<head>
  ...
  <title>Adit and Bai - Webserver</title>
<!--
	...
	<body>
			...
			<div class="container-fluid">
				<div class="row cb-slideshow-text-container ">
					...
					<header class="mb-5"><h1>Aditya And Baihaqi</h1></header>
					<P class="mb-5">Welcome to Our Webserver. Thank you for visiting our site!</P>
				...
				<div class="footer-link">
					<p>Copyright © 2020 Aditya & Baihaqi
